...
# 开始模型训练
model = Sequential()
model.add(Embedding(trainable=True, input_dim=vocalen, output_dim=300, input_length=maxlen))  # input_length 是序列长度
model.add(Flatten())
...
score, acc = model.evaluate(x_train_index, y_train)
